const AppIcons = {
    ...
    // Dashboard - Rewritten: Cleaner grid layout
    ...
    // Settings - Rewritten: Much cleaner cogwheel
    ...
    // Stop (Service) - Rewritten: Clearer stop button inside a circle
    ...
    // Trash - Rewritten: Cleaner lines, separated lid
    ...
    // Refresh - Rewritten: Standard circular arrow, no weird coordinates
...
const IconComponent = {
    props: ['name', 'class'],
    template: `<span v-html="icon" :class="$props.class"></span>`,
    computed: {
        icon() {
            return AppIcons[this.name] || '';
        }
    }
};